 up1 = im2double(imread('b1.jpg'));
 up2 = im2double(imread('b2.jpg'));
 up3=  im2double(imread('b3.jpg'));
 up4 = im2double(imread('b4.jpg'));
 up5 = im2double(imread('b5.jpg'));
 up6 = im2double(imread('b6.jpg'));
 up7 = im2double(imread('b7.jpg'));
