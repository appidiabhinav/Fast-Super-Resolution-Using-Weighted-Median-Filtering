 up1 = im2double(imread('c1.jpg'));
 up2 = im2double(imread('c2.jpg'));
 up3=  im2double(imread('c3.jpg'));
 up4 = im2double(imread('c4.jpg'));
 up5 = im2double(imread('c5.jpg'));
 up6 = im2double(imread('c6.jpg'));
 up7 = im2double(imread('c7.jpg'));
